...
export function changePersonalInfo(fieldType: string, field: string, value: string) {
  return {
...
export function handleDifferentDeliveryAddress(checked: boolean) {
  return {
    type: HANDLE_DIFFERENT_DELIVERY_ADDRESS,
    checked,
  };
}
